...
public class TextureAtlas
{
    ...
    public void CreateAtlas()
    {
        ...
        try(Stream<Path> filePathStream=Files.walk(Paths.get("src\\main\\resources\\textures\\tiles")))
        {
            ...
            for (File file : files)
            {
                try(BufferedInputStream in = new BufferedInputStream(this.getClass().getResourceAsStream("/textures/tiles/" + file.getName())))
                {
