...
import com.deadvikingstudios.bygul.controller.input.KeyboardInputHandler;
import com.deadvikingstudios.bygul.controller.input.MouseInputHandler;
import com.deadvikingstudios.bygul.controller.input.MousePositionHandler;
import com.deadvikingstudios.bygul.controller.modloading.ModLoader;
import com.deadvikingstudios.bygul.model.entities.Entity;
import com.deadvikingstudios.bygul.model.entities.EntitySkybox;
import com.deadvikingstudios.bygul.model.entities.Faction;
import com.deadvikingstudios.bygul.model.entities.ai.tasks.TaskPlaceTile;
import com.deadvikingstudios.bygul.model.events.TaskEventHandler;
...
import com.deadvikingstudios.bygul.model.world.CalendarNorse;
...
import com.deadvikingstudios.bygul.view.guis.GuiRenderer;
import com.deadvikingstudios.bygul.view.guis.GuiTexture;
import com.deadvikingstudios.bygul.view.meshes.*;
import com.deadvikingstudios.bygul.view.renderers.Renderer;
import com.deadvikingstudios.bygul.view.renderers.LightlessRenderer;
import com.deadvikingstudios.bygul.view.renderers.RendererWater;
import com.deadvikingstudios.bygul.view.shaders.LightlessStaticShader;
...
//    public static final String SRC_PATH = "/src/main/java/com/deadvikingstudios/bygul/";
...
//        guiTextures.add(new GuiTexture(waterFBOs.getReflectionTexture(), new Vector2f(0.25f,0.75f), new Vector2f(0.25f,0.25f)));
    ...
    {
        //TODO: move these into the Mod's init method
        //**** SKYBOX ****//
        skyboxTexture = new MeshTexture(loader.loadTexture("norsetown/textures/skybox"));
        //**** TERRAIN ****//
        terrainTexture = new MeshTexture(loader.loadTexture("norsetown/textures/terrain"));//"norsetown.textures/tiles/grass_top"));
        //**** TEST ****//
        skullTexture = new MeshTexture(loader.loadTexture("norsetown/textures/skull_logo"));
    }
...
//        camera.setRotation(35, 135, 0);//135
    ...
    public void init()
    {
        ...
        ModLoader.preInitMods(this);
        ModLoader.initMods(this);
        ModLoader.postInitMods(this);

        //TODO eventBus, seperate into preinit, init, and postinit
        initTextures();
        initGlobalLights();
        initCamera();
...
//        TextureAtlas.instance.CreateAtlas();
    ...
    public void update(float dt)
    {
        ...
        if(MouseInputHandler.isButtonPressed(GLFW.GLFW_MOUSE_BUTTON_LEFT))
        {
            ...
            int y = -1;
            while(!currentWorld.getCurrentBuildStructure().getTile(x,y,z).isAir())
            {
                y++;
            }
            Vector3i pos = new Vector3i(x,y,z);
            TaskEventHandler.createTask(Faction.get("player"), new TaskPlaceTile(World.getCurrentWorld().getCurrentBuildStructure(), NorseTiles.tileLeaves, pos, 1));
