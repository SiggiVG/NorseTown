...
{
    public TileLeaves(String unlocalizedName, EnumMaterial material)
    {
...
//    );
    ...
    private static final TileMesh MESH = new TileMesh(
            new TileMeshDef.Cuboid(16, new Vector3f(0.25f, 0.25f,0.25f), new Vector3f(0.75f, 0.75f,0.75f)),
            ...
            new TileMeshDef.Cuboid(16, new Vector3f(-0.25f,0.5f,-0.25f), new Vector3f(0.5f,0.5f,0.5f),
                    new Vector3f(0,45,45)),
            new TileMeshDef.Cuboid(16, new Vector3f(-0.25f,0.5f,0.5f), new Vector3f(0.5f,0.5f,1.25f),
                        new Vector3f(45,45,0)),
            new TileMeshDef.Cuboid(16, new Vector3f(0.5f,0.5f,0.5f), new Vector3f(1.25f,0.5f,1.25f),
                        new Vector3f(0,45,-45)),
            new TileMeshDef.Cuboid(16, new Vector3f(0.5f,0.5f,-0.25f), new Vector3f(1.25f,0.5f,0.5f),
                        new Vector3f(-45,45,0))
    );
